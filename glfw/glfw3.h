 ...
 *  bar.  Otherwise a minimal menu bar is created manually with text commands
 *  like Hide, Quit and About.  The About entry opens a minimal about dialog
 *  with information from the application's bundle.  Game bar creation can be
 ...
 *  values must be greater than zero.  For example, the text 16:9 aspect ratio
